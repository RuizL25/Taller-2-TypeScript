...
export const series = [
  new Serie(
    ...
    "https://www.concierto.cl/wp-content/uploads/2017/03/Breaking-Bad.jpg"
  ),
  ...
  new Serie(
    ...
    "https://estaticos-cdn.elperiodico.com/clip/ee1955b1-05da-4b9d-b38c-68111edb88cc_alta-libre-aspect-ratio_default_0.jpg"
  ),
  ...
  new Serie(
    ...
    "https://elcomercio.pe/resizer/J77CTOCySvrZ-HpEyhkX0-TRpzo=/580x330/smart/filters:format(jpeg):quality(75)/arc-anglerfish-arc2-prod-elcomercio.s3.amazonaws.com/public/UMGSPIQNJZFXFCNVDB5RD5WXLY.jpg"
  ),
  ...
  new Serie(
    ...
    "https://imagenes.elpais.com/resizer/GB_Q8Dc4wM9VQbkgSJYhhQ5c2vk=/1960x1103/ep01.epimg.net/cultura/imagenes/2017/09/24/television/1506207395_359058_1506247478_noticia_fotograma.jpg"
  ),
  ...
  new Serie(
    ...
    "https://static.eldiario.es/clip/e98fcefa-7ad4-482d-9aea-d07c1ac6d79c_16-9-aspect-ratio_default_0.jpg"
  ),
];


export const data = series.map(serie => new Serie(serie.id, serie.name, serie.channel, serie.seasons, serie.description, serie.platform, serie.image));
